...
* **Phase 4: Prepare the Overcloud**
  ...
  - **Phase 4.3: Modify the Overcloud Image**
    ...
    If you are using the *No Patching* process, skip this phase and follow the steps in the `Phase 4.4: Worflow`_
...
4. This script takes in *nuage_patching_config.yaml* as input parameters. You need to configure the following parameters:
   ...
   * logFileName is used to pass log filename.
   ...
   For examples of nuage_patching_config.yaml, go to `nuage_patching_config.yaml for the Nuage Patching Configuration`_.
   ...
   c. If the ``openstack image list`` command returns the output similar to this:
      ...
      Run the following commands to update the images to Glance:
        ...
        ::
            ...
            (undercloud) [stack@director images]$ openstack overcloud node c
...
nuage_patching_config.yaml for the Nuage Patching Configuration
-----------------------------------------------------------------
...
3. Run this command to start the patching workflow:
